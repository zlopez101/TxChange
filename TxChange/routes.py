...
def new_ticket():
	form = NewTicket()
	if form.validate_on_submit():
		ticket = Ticket(artist=form.artist.data, venue=form.venue.data, price=form.price.data, concert_date=form.concert_date_time.data)
		...
		return redirect(url_for("home"))
	return render_template("new_ticket.html", title="Post a New Ticket")
